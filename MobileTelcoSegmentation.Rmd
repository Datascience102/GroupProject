...
```{r setuplibraries, echo=TRUE, message=FALSE}
...
We can see the histogram of, say, the first 5 variables (can you change the code chunk in the raw .Rmd file to see other variables?)
...
```{r}
#Hierarchical_Cluster_distances <- dist(NEW_ProjectData, method=distance_used)
